...
* [Karën Fort](https://members.loria.fr/KFort/) (Laboratorie Lorrian de Recherche en Informatique et ses Applications – LORIA)
...
In 2024, the ACL Ethics Committee (AEC) decided to propose to run a tutorial on ethics and its impact on ethics in both authoring and reviewing aspects for the community of CL/NLP scholars and practitioners.  As part of this process, the AEC Committee put together the [proposal file](https://github.com/acl-org/ethics-website/blob/main/docs/tutorials/Ethics_Tutorial_Proposal__ACL_2025.pdf) and submitted it to the joint call for tutorial proposals.

The tutorial was accepted to run at [ACL 2025](https://2025.aclweb.org/) (Vienna, Austria, 27 July to 1 August) on Sundey, 27 July from 14:00 to 17:30hs in Hall M at the venue. The tutorial will be hybrid and we will have online moderators for the virtual participants. 
...
TO BE UPDATED Google Slides permalink for EACL 2023 tutorial: [http://bit.ly/eacl23-ethics-slides](http://bit.ly/eacl23-ethics-slides)
